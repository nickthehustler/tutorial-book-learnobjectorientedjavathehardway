public class PopularStaticMethods {
  public static void main(String[] args) {
    ...
    System.out.println("Using the decrementExact() method in Math class: " + Math.decrementExact(1000));
    System.out.println("The '1111' binary number is " + Integer.valueOf("1111", 2) + " in decimal notation.");
  }
}
