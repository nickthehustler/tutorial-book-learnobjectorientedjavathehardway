public class JavaHardArrayListDriver {
  public static void main(String[] args) {
    ...
    System.out.println("Before: 'bins' array: " + bins.toString());
    bins.add(11, 62);
    System.out.println("After: 'bins' array: " + bins.toString());
    bins.add(62);
    System.out.println("After after: 'bins' array: " + bins.toString());
